...
data_path = "/Users/dobby/Library/Mobile Documents/com~apple~CloudDocs/electronicsandcode/code/arcticfo111/ms_06team/ms_team_cardata/final_data_combination1/car_dataset/images"
...
for path in data_path_list :
    ...
    all()문법으로 반복 가능한 항목(예를들어 요소가 3개인 리스트)의 모든 요소가 참일경우 참을 반환한다.
    for classnum in [1., 2., 3.])에서 classnum은 차례로 [1., 2., 3.]안의 요소가 된다. 
